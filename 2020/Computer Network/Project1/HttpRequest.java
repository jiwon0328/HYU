...
final class HttpRequest implements Runnable {
    ...
    private void sendResponseMessage(FileInputStream fis, DataOutputStream os) throws Exception {
        ...
        if (code != StatusCode.OK)
            entityBody = entityBody.replaceAll("\\?", message + " - sent by Jiwon's WebServer");
    ...
    private String parseRequestLine(String requestLine) {
        ...
        if (tokens.countTokens() != 3) {
            code = StatusCode.NOT_FOUND;    // Mission 4 : STATUS CODE 404 NOT FOUND
        ...
        if (file.isDirectory()) {
            ...
            if (list == null || list.length == 0) {
                ...
                return "Found more than one index file at requested location " + fileName + ". Returning INTERVAL SERVER ERROR.";
            }
            // Found index file.
            file = list[0];
        }
        ...
        if(version.equals("HTTP/1.0")) {
            code = StatusCode.BAD_REQUEST;  // Mission 5 : STATUS CODE 400 NOT BAD REQUEST
        ...
        if (!version.equals("HTTP/1.0") && !version.equals("HTTP/1.1")) {
            ...
            return version + " not supproted. Returning HTTP VERSION NOT SUPPORTED.";
        }
        code = StatusCode.OK;   // Mission 3 : STATUS CODE 200 OK
        return null;
    }
